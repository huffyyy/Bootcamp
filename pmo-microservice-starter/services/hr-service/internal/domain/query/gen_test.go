...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Country.UnderlyingDB().Statement.Context,
		qCtx.Department.UnderlyingDB().Statement.Context,
		qCtx.Dependent.UnderlyingDB().Statement.Context,
		qCtx.Employee.UnderlyingDB().Statement.Context,
		qCtx.EmployeeDocument.UnderlyingDB().Statement.Context,
		qCtx.Job.UnderlyingDB().Statement.Context,
		qCtx.Location.UnderlyingDB().Statement.Context,
